...
const Dashboard = () => {
  ...
  const navLinkStyle = (active) => ({
    ...
    boxShadow: active ? "0 4px 20px rgba(10, 116, 233, 0.3)" : "none",
    ...
    >
      ...
      >
        ...
        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
          ...
          <li style={{ marginBottom: 18 }}>
            <Link to="/user/myexam" style={navLinkStyle(isActive("/user/myexam"))}>
              My Exams
            </Link>
          </li>
          <li style={{ marginBottom: 18 }}>
            <Link to="/user/myresult" style={navLinkStyle(isActive("/user/myresult"))}>
              Results
            </Link>
          </li>
          <li style={{ marginBottom: 18 }}>
